...
var _Fetcher = __webpack_require__(16);
...
var person = new _Person2.default("John Johnson", new _Job2.default("Brick Layer", 26000));

var token = "pk.eyJ1Ijoic2NvdHRiZXJ3aWNrbG9uZG9udG93biIsImEiOiJjMVFnelBzIn0.jDehcQpMLsuwgNQP2Hafgg";

/* Cycle up the event */
document.addEventListener("DOMContentLoaded", function () {

	var fetchWrapper = new _Fetcher2.default();
	var people = new _People2.default();
	fetchWrapper.get("example.json", function (p) {
		people.people(p);
	});

	var map = new _Map2.default(token);
	var mapInstance = map.defineMapInstance("w-map-instance", "mapbox://styles/scottberwicklondontown/cj95tj1sv1jtw2rliwiggiddw", -0.367165, 51.421128, 10);
});
...
var Job = function () {
    function Job(jobname, annualsalary) {
    ...
    _createClass(Job, [{
        ...
        get: function get() {
            var monthly = 0;
            var taxfreeamount = 11500;
            var percent20 = 33500;
            var gross = this._annualsalary;
            var amount = 0;
...
var Map = function () {
    ...
    _createClass(Map, [{
         ...
         * @return <mapbox object>
         */
        value: function defineMapInstance(container, style, lat, lon, zoom) {
        ...
        key: "disableAttributeModel",
        value: function disableAttributeModel() {
